...
#Region " Declarations "
    ...
    'this is a style brush from tazz
    Private stylebrush As New SolidBrush(Color.RoyalBlue)
    Private captionbrush As New SolidBrush(Color.CornflowerBlue)
    'this is the background color of the rectangles from tazz
    Private BackColor1 As Color = System.Drawing.Color.SlateGray
    Private BackColor2 As Color = Color.Snow
    ...
    Private myDrawFont As New Font("Courier New", 10, FontStyle.Underline)
...
#Region " PrintPage Callback event "
    ...
    Private Sub PrintDataSet(ByVal Sender As Object, ByVal ev As PrintPageEventArgs) Handles myDocumentToPrint.PrintPage
        ...
        'the format of our desired text
        Dim stringformat As New StringFormat()
        Dim strformat As New StringFormat()
        ' Center each line of text.
        Dim imglogo As Image = Image.FromFile("buttons.gif")
        ...
        ev.Graphics.DrawString(aHeaderObj.ToString, myDrawFontBold, stylebrush, aXPos, aYPos)
        'ev.Graphics.DrawImage(imglogo, aXPos - 8, aYPos + 9)
        Dim destRect1 As New Rectangle(aXPos + 200, aYPos + 20, 80, 1000)
        ...
        ev.Graphics.FillRectangle(New Drawing2D.LinearGradientBrush(destRect1, BackColor2, BackColor1, Drawing2D.LinearGradientMode.Vertical), destRect1)
        'ev.Graphics.DrawImage(imglogo, destRect1)
        Dim Rectlogo As New Rectangle(aXPos + 2, aYPos + 20, 1000, 40)
        ev.Graphics.FillRectangle(New Drawing2D.LinearGradientBrush(Rectlogo, BackColor1, BackColor2, Drawing2D.LinearGradientMode.Vertical), Rectlogo)
        'ev.Graphics.DrawString("__________________________________________________________________________________________________________________________________________________", myDrawFontBold, stylebrush, aXPos + 2, aYPos + 9)
        strformat.FormatFlags = StringFormatFlags.DirectionVertical
        'ev.Graphics.DrawString("__________________________________________________________________________________________________________________________________________________", myDrawFontBold, stylebrush, aXPos, aYPos + 21, strformat)
        '
        ...
        For aColIndex = aFirstColToPrint To aColsToPrint
            ...
            If aPrintIt Then
                ...
                If (aXPos + aLayoutSize.Width) <= ev.MarginBounds.Right Then
                    ev.Graphics.DrawString(Left(aCol.Caption, aCharactersFitted), myDrawFontBold, captionbrush, aXPos + 5, aYPos + 9, stringformat)
                    'ev.Graphics.DrawString("__________________________________________________________________________________________________________________________________________________", myDrawFont, captionbrush, aXPos + 2, aYPos + 14)
                    ev.Graphics.DrawString(" ", myDrawFont, myDrawBrush, aXPos, aYPos + 14)
            ...
            If aRow.RowState <> DataRowState.Deleted Then
                ...
                For aColIndex = aFirstColToPrint To myLastColPrinted
                    ...
                    If aPrintIt Then
                        ...
                        '
                        'ev.Graphics.DrawString("__________________________________________________________________________________________________________________________________________________", myDrawFont, myDrawBrush, aXPos, aYPos + 14)
                        ev.Graphics.DrawString(" ", myDrawFont, myDrawBrush, aXPos, aYPos + 4)
                        ev.Graphics.DrawString(aValue, myDrawFont, myDrawBrush, aXPos + 5, aYPos + 14)
                        ev.Graphics.DrawString(" ", myDrawFont, myDrawBrush, aXPos, aYPos + 10)
                        aXPos += aLayoutSize.Width
                    End If
                Next
