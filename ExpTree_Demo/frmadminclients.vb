...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents cboaddeditclients As System.Windows.Forms.CheckBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmadminclients))
        ...
        Me.cboaddeditclients = New System.Windows.Forms.CheckBox
        ...
        Me.StiGroupBox1.Size = New System.Drawing.Size(360, 164)
        Me.StiGroupBox1.TabIndex = 0
        Me.StiGroupBox1.TabStop = False
        Me.StiGroupBox1.Text = "Clients"
        '
        'btnok
        '
        ...
        Me.btnclose.Location = New System.Drawing.Point(272, 136)
        ...
        Me.grpchanges.Controls.Add(Me.cbreports)
        Me.grpchanges.Controls.Add(Me.cboaddeditclients)
        ...
        'cbreports
        '
        Me.cbreports.Location = New System.Drawing.Point(16, 40)
        Me.cbreports.Name = "cbreports"
        Me.cbreports.Size = New System.Drawing.Size(168, 16)
        Me.cbreports.TabIndex = 5
        Me.cbreports.Text = "Print reports on clients"
        '
        'cboaddeditclients
        '
        Me.cboaddeditclients.Location = New System.Drawing.Point(16, 16)
        Me.cboaddeditclients.Name = "cboaddeditclients"
        Me.cboaddeditclients.Size = New System.Drawing.Size(168, 16)
        Me.cboaddeditclients.TabIndex = 4
        Me.cboaddeditclients.Text = "Add and edit clients"
        '
        'cbviewonly
        '
        ...
        Me.cbmakechanges.Text = "Can make changes to clients"
        '
        'frmadminclients
        '
        ...
        Me.Name = "frmadminclients"
        Me.Text = "administer rights to clients"
...
#End Region
    ...
    Private Sub btnok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnok.Click
        Try
            ...
            Else
                strf = "1"
                If Me.cboaddeditclients.Checked = True Then
                    strf += ",1"
                Else
                    strf += ",0"
                End If
                If Me.cbreports.Checked = True Then
                    strf += ",1"
                Else
                    strf += ",0"
                End If
    ...
    Private Sub cbmakechanges_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbmakechanges.Click
        ...
        End Try
    End Sub
    Private Sub frmadminclients_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Dim array() As String
            array = strin.Split(",")
            If array(0) = "0" Then
            ...
            Else
                ...
                Me.grpchanges.Enabled = True
                If array(1) = "1" Then
                    Me.cboaddeditclients.Checked = True
                Else
                    Me.cboaddeditclients.Checked = False
                End If
                If array(2) = "1" Then
                    Me.cbreports.Checked = True
                Else
                    Me.cbreports.Checked = False
                End If
            End If
