...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmAddContacts))
        ...
        Me.GroupBox1.Controls.Add(Me.btnAddContacts)
        ...
        Me.GroupBox1.Size = New System.Drawing.Size(328, 344)
        ...
        Me.txtcellphone2.Location = New System.Drawing.Point(129, 167)
        ...
        'txtdesc
        '
        Me.txtdesc.Location = New System.Drawing.Point(128, 268)
        ...
        'lbldesc
        '
        Me.lbldesc.Location = New System.Drawing.Point(16, 268)
        ...
        'lblEMail2
        '
        Me.lblEMail2.Location = New System.Drawing.Point(16, 244)
        ...
        'txtEmail2
        '
        Me.txtEmail2.Location = New System.Drawing.Point(128, 244)
        ...
        Me.btnClose.Location = New System.Drawing.Point(199, 316)
        ...
        Me.txtPhysicalAddress.Location = New System.Drawing.Point(128, 292)
        ...
        Me.txtEMail1.Location = New System.Drawing.Point(128, 220)
        ...
        Me.txtPostalAddress.Location = New System.Drawing.Point(128, 196)
        ...
        Me.lblPhysicalAddress.Location = New System.Drawing.Point(16, 292)
        ...
        Me.lblEMail.Location = New System.Drawing.Point(16, 220)
        ...
        Me.lblPostalAddress.Location = New System.Drawing.Point(16, 196)
        ...
        Me.ClientSize = New System.Drawing.Size(344, 388)
...
#End Region
    ...
    End Sub
    Private Sub txtClientNo_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub
    Private Sub GroupBox1_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GroupBox1.Enter

    End Sub
    Private Sub frmAddContacts_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnAddContacts_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddContacts.Click
        Try
            Me.Invoke(New mydelegate(AddressOf addcon))
    ...
    Private Sub addcon()
        ...
        Try
            ...
            strsql = "insert into contact" _
            & " (client_no,f_name,tel,fax,cell,e_mail2,s_name,salutation,description," _
            & " pobox,physicaladd,e_mail1,mobile2) values"
            strsql = strsql & "(" & "'" & Me.lblClientNo.Text & "',"
            strsql = strsql & "'" & strin & "',"
            strsql = strsql & "'" & strin1 & "',"
            strsql = strsql & "'" & strin2 & "',"
            strsql = strsql & "'" & strin3 & "',"

            strsql = strsql & "'" & strin4 & "',"
            strsql = strsql & "'" & strin5 & "',"
            strsql = strsql & "'" & strin6 & "',"
            strsql = strsql & "'" & strin7 & "',"

            strsql = strsql & "'" & strin8 & "',"
            strsql = strsql & "'" & strin9 & "',"
            strsql = strsql & "'" & strin10 & "',"
            strsql = strsql & "'" & strin11 & "'"
            strsql = strsql & ")"
            connect.BeginTrans()
            connect.IsolationLevel = ADODB.IsolationLevelEnum.adXactSerializable
            connect.Execute(strsql)
            connect.CommitTrans()
            MessageBox.Show(Text:="Contacts successfully added", _
    ...
    Protected Overrides Function ProcessDialogKey(ByVal keyData As System.Windows.Forms.Keys) As Boolean
        Try
            ...
            If keyData = System.Windows.Forms.Keys.Return Then
                ...
                'If Me.btnClose.Focus = True Then
                '    Call btnClose_Click(Me, E)
                '    Exit Try
                'End If
                'Me.Invoke(New mydelegate(AddressOf addcon))
                'Call btnAddContacts_Click(Me, E)
