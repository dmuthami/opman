...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmdepartments))
        ...
        Me.GroupBox2.Size = New System.Drawing.Size(328, 266)
        Me.GroupBox2.TabIndex = 0
        Me.GroupBox2.TabStop = False
        Me.GroupBox2.Text = "Add and edit departments"
        '
        'btndelete
        '
...
#Region "departments"
        ...
        Try
            ...
            With rs
                ...
                If .BOF = False And .EOF = False Then
                    ...
                    equipDA.Fill(equipDS, rs, "department")
    ...
    Public Sub addequiptablestyle(ByVal namme As String)
        Try
            ...
            myn.MappingName = "dept"
            myn.HeaderText = "Department"
            myn.Width = mywidth
    ...
    Private Sub btnadd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnadd.Click
        ...
        Try
            ...
            For y = 0 To int - 1
                If Convert.ToString(ds.Tables(0).Rows(y).Item("ano")).Length < 1 Then
                    strsql += " insert into department (dept) values"
                    strsql += "  ('" & ds.Tables(0).Rows(y).Item("dept") & "') ;"
                Else
                    strsql += " update department set dept"
                    strsql += "='" & ds.Tables(0).Rows(y).Item("dept") & "' "
        ...
        End Try
        Try
            Dim _thread1 As Thread = New Thread(AddressOf myForms.CustomerForm2.ld)
            Try
        ...
        End Try
        Try
            Dim _thread2 As Thread = New Thread(AddressOf myForms.CustomerForm.ld)
            Try
        ...
        End Try
        Try
            Dim _thread4 As Thread = New Thread(AddressOf myForms.CustomerForm4.ld)
            Try
                If _thread4.IsAlive = True Then
                    _thread4.Abort()
                End If
            Catch ex As Exception
    ...
    Private Sub btndelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btndelete.Click
        Try
            Dim x As Boolean = myForms.Main.canviewjobss
            If x = False Then
                MessageBox.Show("Not allowed to delete department details contact administrator", "Department", _
        ...
        Try
            ...
            str = "delete from department where ano='" & sid & "';"
            Try
                connect.BeginTrans()
                connect.Execute(str)
                connect.CommitTrans()
            ...
            Catch cv As Exception
                MessageBox.Show("Department deleted successfully", "Departmen", _
               MessageBoxButtons.OK, MessageBoxIcon.Information)
            End Try
            Try
                connect.Close()
