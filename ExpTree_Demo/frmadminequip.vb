...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents cbreportequip As System.Windows.Forms.CheckBox
    Friend WithEvents cbeditequip As System.Windows.Forms.CheckBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmadminequip))
        ...
        Me.cbreportequip = New System.Windows.Forms.CheckBox
        Me.cbeditequip = New System.Windows.Forms.CheckBox
        ...
        Me.StiGroupBox1.Location = New System.Drawing.Point(1, -1)
        Me.StiGroupBox1.Name = "StiGroupBox1"
        Me.StiGroupBox1.Size = New System.Drawing.Size(391, 169)
        Me.StiGroupBox1.TabIndex = 0
        Me.StiGroupBox1.TabStop = False
        Me.StiGroupBox1.Text = "Equipment"
        '
        'btnok
        '
        ...
        Me.btnclose.Location = New System.Drawing.Point(312, 136)
        ...
        Me.grpchanges.Controls.Add(Me.cbreportequip)
        Me.grpchanges.Controls.Add(Me.cbeditequip)
        ...
        Me.grpchanges.Size = New System.Drawing.Size(376, 96)
        ...
        'cbreportequip
        '
        Me.cbreportequip.Location = New System.Drawing.Point(16, 40)
        Me.cbreportequip.Name = "cbreportequip"
        Me.cbreportequip.Size = New System.Drawing.Size(168, 16)
        Me.cbreportequip.TabIndex = 5
        Me.cbreportequip.Text = "Print reports on equipments"
        '
        'cbeditequip
        '
        Me.cbeditequip.Location = New System.Drawing.Point(16, 16)
        Me.cbeditequip.Name = "cbeditequip"
        Me.cbeditequip.Size = New System.Drawing.Size(168, 16)
        Me.cbeditequip.TabIndex = 4
        Me.cbeditequip.Text = "Add and edit equipments"
        '
        'cbviewonly
        '
        ...
        Me.cbmakechanges.Size = New System.Drawing.Size(184, 16)
        Me.cbmakechanges.TabIndex = 2
        Me.cbmakechanges.Text = "Can make changes to equipment"
        '
        'frmadminequip
        '
        ...
        Me.Name = "frmadminequip"
        Me.Text = "administer rights to equipments"
...
#End Region
    ...
    Private Sub btnok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnok.Click
        Try
            ...
            Else
                strf = "1"
                If Me.cbeditequip.Checked = True Then
                    strf += ",1"
                Else
                    strf += ",0"
                End If
                If Me.cbreportequip.Checked = True Then
                    strf += ",1"
                Else
                    strf += ",0"
                End If
    ...
    Private Sub cbmakechanges_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbmakechanges.Click
        ...
        End Try
    End Sub
    Private Sub frmadminequip_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Dim array() As String
            array = strin.Split(",")
            If array(0) = "0" Then
            ...
            Else
                ...
                Me.grpchanges.Enabled = True
                If array(1) = "1" Then
                    Me.cbeditequip.Checked = True
                Else
                    Me.cbeditequip.Checked = False
                End If
                If array(2) = "1" Then
                    Me.cbreportequip.Checked = True
                Else
                    Me.cbreportequip.Checked = False
                End If
            End If
