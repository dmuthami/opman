...
#Region "   MakeFolderFromBytes"
    Public Shared Function MakeFolderFromBytes(ByVal b As Byte()) As ShellDll.IShellFolder
        ...
        Else
            ...
            Dim hr = DesktopBase.Folder.BindToObject(ptr, IntPtr.Zero, IID_IShellFolder, MakeFolderFromBytes)
...
#Region "       GetContents"
    ...
    '''  ArrayList of IntPtrs to RELATIVE PIDLs for the contents of this Folder</parm>
...
#Region "       Really nasty Pidl manipulation"
    ...
    ''' If given a pointer to the Desktop, will return same pointer.
    '''<remarks>This is what the API ILFindLastID does, however IL... 
    ''' functions are not supported before Win2K.
    Public Shared Function GetLastID(ByVal pidl As IntPtr) ', Optional ByVal dbg As Boolean = True) As IntPtr
        If Not pidl.Equals(IntPtr.Zero) Then
    ...
    Private Shared Function PIDLClone(ByVal pidl) As IntPtr
